...
export class MasterDoa implements IDao {
  ...
  public async get(callback?: ICallback): Promise<any> {
  ...
  public async put(data, callback?): Promise<any> {
    let promise;
    try {
  ...
  public async delete(doc, callback?: ICallback): Promise<any> {
    if (!callback) {
  ...
  public async updateWhere(field, value, operator?, callback?) {
    if (!callback) {
  ...
  public where(field: any, value: any, operator?: any) {
    Object.assign(this.query.selector, this.buildWhereClause(field, value, operator));
    return this;
  }

  public async first(callback?: ICallback): Promise<any> {
    let result;
    if (!callback) {
  ...
  public async apply(callback?: ICallback): Promise<any> {
    let result;
    if (!callback) {
      result = await this.database.find(this.query);
      return result.docs;
  ...
  public orderBy(field, order?): any {
  ...
  public async deleteWhere(field, value, operator?, callback?: ICallback): Promise<any> {
    if (!callback) {
  ...
  public orWhere(field: any, value, operator?): any {
    this.query.selector = {
